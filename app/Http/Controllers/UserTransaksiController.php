...
class userTransaksiController extends Controller
{
    ...
    { 
        ...
        $user = Auth::user();
               ...
               // Get transactions for the authenticated user with related models
               $transaksis = Transaksi::with(['user', 'ruangan', 'layanan', 'dokter'])
               ->where('id_user', $user->id)
               ->latest()
               ->paginate(10);
        //render view with transaksi
        return view('userTransaksi', compact('transaksis'));
    }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function create(): View
    {
        ...
        $ruangans = Ruangan::all();
              ...
              return view('userTransaksiCreate', [
                  'users' => $users,
                  'layanans' => $layanans,
                  'dokters' => $dokters,
                  'ruangans' => $ruangans,
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        //redirect to index
        return redirect()->to('/user/transaksi')->with(['success' => 'Data Berhasil Disimpan!']);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    {
        //get Transaksi by kode_trx
        $transaksis = Transaksi::where('kode_trx', $kode_trx)->firstOrFail();
    
        //render view with product
        return view('userTransaksiShow', compact('transaksis'));
    }
...
/**
    ...
    public function edit(string $kode_trx): View
    {
        ...
        return view('userTransaksiEdit', compact('transaksis'));
    }
    ...
    public function update(Request $request, $kode_trx): RedirectResponse
    {
        ...
        //redirect to index
        return redirect()->to('/user/transaksi')->with(['success' => 'Data Berhasil Diubah!']);
    }
...
/**
    ...
    public function confirm(string $kode_trx): View
    {
        ...
        return view('userTransaksiConfirm', compact('transaksis', 'users', 'layanans', 'dokters', 'ruangans'));
    }
    ...
    public function cancel(string $kode_trx): View
    {
        ...
        // Mengirim data tiket ke view
        return view('userTransaksiCancel', compact('transaksis', 'users', 'layanans', 'dokters', 'ruangans'));
    }
