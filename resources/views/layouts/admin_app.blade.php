    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark text-light shadow-sm">
            ...
            <i class='fas fa-laptop-medical' style='font-size:36px'></i> 
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ __('/admin/transaksi') }}">Transaksi</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{ __('/admin/layanan') }}">Layanan</a>
                    </li>
                    
                    <li class="nav-item">
                        <a class="nav-link" href="{{ __('/admin/ruangan') }}">Ruangan</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{ __('/admin/dokter') }}">Dokter</a>
                    </li>
