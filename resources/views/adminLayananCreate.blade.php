                                    ...
                                    <div class="card-body">
                                        ...
                                        <hr>
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control @error('nama_layanan') is-invalid @enderror" name="nama_layanan" value="{{ old('nama_layanan') }}" placeholder="Masukkan nama layanan">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number" class="form-control @error('harga_layanan') is-invalid @enderror" name="harga_layanan" value="{{ old('harga_layanan') }}" placeholder="Masukkan nama layanan">
