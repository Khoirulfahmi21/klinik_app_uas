                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card border-0">
                                    <div class="card-body">
                                        <form action="{{ route('dokter.update', $dokters->id_dokter) }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('nama_dokter') is-invalid @enderror" name="nama_dokter" value="{{ old('nama_dokter', $dokters->nama_dokter) }}" >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                            ...
                                                            <select name="spesialisasi" class="form-select">
                                                                <option value="{{ old('spesialisasi', $dokters->spesialisasi) }}" selected>{{ old('spesialisasi', $dokters->spesialisasi) }}</option>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <select name="jadwal_praktik" class="form-select">
                                                                <option selected>{{ old('jadwal_praktik', $dokters->jadwal_praktik) }}</option>
